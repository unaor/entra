...
public class FeedBackDaoImpl implements FeedBackDao {
	...
	public void createFeedback(FeedBack feedback) throws DaoException {
		...
		logger.debug("adding feedback to client "+feedback.getClient().getUserId());
	...
	public List<FeedBack> getClientFeedBacks(Long clientId) throws DaoException {
		Session session = sessionFactory.getCurrentSession();
		List<FeedBack> feedbacks = session.createQuery("from FeedBack fb where fb.client.userId=:clientId").
	...
	public List<FeedBack> getFeedbacksByUser(Long userId) throws DaoException {
		Session session = sessionFactory.getCurrentSession();
		List<FeedBack> feedbacks = session.createQuery("from FeedBack fb where fb.user.userId=:userId").
